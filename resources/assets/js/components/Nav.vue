		...
		<div ref="teamSummary" v-show="showSummary" class="team-summary text-center animated fadeInDown">
			<span class="badge badge-dark">
				...
				<span class="summary-costs">
					<img src="/images/icons/drum.svg" class="ml-sm-3"> {{ summary.cost }} cans
				</span>
			</span>
		</div>
			...
			<ul class="navbar-nav ml-auto">
				<li class="nav-item">
					<a class="nav-link" href="#" v-on:click.prevent="addTeam">
						<i class="fas fa-lg fa-fw fa-plus-square"></i> <span class="d-lg-none"> Start a New Teams</span>
					</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="#" v-on:click.prevent="showGarage" v-bind:class="{ disabled: !loggedIn }">
						...
						<span class="d-lg-none"> View My Teams</span>
						<span class="team-count-badge badge badge-light" v-show="teamCount">{{ teamCount }}</span> </a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="#" v-on:click.prevent="saveTeam" v-bind:class="{ disabled: !loggedIn }">
						...
						<span class="d-lg-none">Save Current Team</span> </a>

				</li>
				<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown">
						<i class="fas fa-lg fa-fw fa-cog"></i> <span class="d-lg-none">Settings</span> </a>
				...
				<li class="nav-item dropdown">
					...
					<a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown">
						<span v-show="!loggedIn"><i class="fas fa-lg fa-fw fa-lock"></i></span> <span v-show="loggedIn"><i class="fas fa-lg fa-fw fa-unlock"></i></span>
						<span class="d-lg-none">Auth</span> </a>

<div id="helpModal" class="modal fade d-print-none" tabindex="-1">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<ul>
					...
					<li>
						<a href="https://jquery.com/" target="_blank">jQuery</a> because it makes everything easier
					</li>
					<li>
						<a href="https://lodash.com/" target="_blank">Lodash</a> for neat collection, object and array functions
					</li>
					<li>
						<a href="https://github.com/axios/axios" target="_blank">Axios</a> for XHR
					</li>
					<li>
						<a href="https://adodson.com/hello.js/" target="_blank">Hello.js</a> for easy social media authentication
					</li>
					<li>
				...
				<ul>
					...
					<li>
						<a href="https://daneden.github.io/animate.css/" target="_blank">Animate.css</a> for bouncy vehicle cards
					</li>
					<li>
				...
				<ul>
					...
					<li>
						<a href="https://sass-lang.com/" target="_blank">SASS</a> for sensible CSS
					</li>
					<li>
						<a href="https://yarnpkg.com/en/" target="_blank">Yarn</a> and
						<a href="https://www.npmjs.com/" target="_blank">NPM</a> reliable package management
					</li>
				</ul>
			</div>
		</div>
